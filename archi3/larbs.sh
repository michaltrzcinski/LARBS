...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/michaltrzcinski/voidrice.git" && repobranch="archi3"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/michaltrzcinski/LARBS/master/archi3/progs.csv"
